...
void GLFramebuffer::addTextureAttachment(const GLenum & type, const GLuint & width, const GLuint & height)
{
...
void GLFramebuffer::addRBOAttachment(const GLuint & width, const GLuint & height)
{
...
const GLuint & GLFramebuffer::texture()
{
	return textureid;
}

GLFramebuffer::operator GLuint()
{
	return fbo;
}
